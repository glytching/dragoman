...
import io.github.glytching.dragoman.configuration.guice.CannedDatasetsModule;
...
import static io.github.glytching.dragoman.util.TestFixture.*;
...
public class MongoCannedDatasetsWriterTest extends AbstractMongoDBTest {
  ...
  @Inject private CannedDatasetsLoader cannedDatasetsLoader;
  @Inject private MongoProvider mongoProvider;
  @Inject private CannedDatasetsWriter cannedDatasetsWriter;
  @Inject private DocumentTransformer documentTransformer;
