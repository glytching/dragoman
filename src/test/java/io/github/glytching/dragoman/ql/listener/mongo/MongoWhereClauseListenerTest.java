...
public class MongoWhereClauseListenerTest {
    ...
    public void testBetween() {
        ...
        assertThat(
                ...
                hasEntry(
                        "a",
                        new BsonDocument().append("$gte", new BsonInt32(5)).append("$lt", new BsonInt32(10))));
    }
    ...
    public void testIn() {
        ...
        assertThat(
                ...
                hasEntry(
                        ...
                        new BsonDocument(
                                "$in",
                                new BsonArray(newArrayList(new BsonString("this"), new BsonString("that"))))));
        assertThat(
                bsonDocument,
                hasEntry(
                        "b",
                        new BsonDocument(
                                "$in", new BsonArray(newArrayList(new BsonInt32(5), new BsonInt32(10))))));
    }
    ...
    public void testNotIn() {
        ...
        assertThat(
                ...
                hasEntry(
                        "b",
                        new BsonDocument(
                                "$nin", new BsonArray(newArrayList(new BsonInt32(5), new BsonInt32(10))))));
    }
    ...
    public void testNotLike() {
        ...
        assertThat(bsonDocument.size(), is(3));
        assertThat(
                bsonDocument, hasEntry("a", new BsonDocument("$not", new BsonRegularExpression("x", ""))));
        assertThat(
                bsonDocument, hasEntry("b", new BsonDocument("$not", new BsonRegularExpression("y$", ""))));
        assertThat(
                bsonDocument, hasEntry("c", new BsonDocument("$not", new BsonRegularExpression("^z", ""))));
    }
    ...
    public void testCombination() {
        ...
        assertThat(
                bsonDocument,
                hasEntry("d", new BsonDocument("$ne", new BsonString("another string value"))));
        ...
        assertThat(
                ...
                hasEntry(
                        "i",
                        new BsonDocument().append("$gte", new BsonInt32(5)).append("$lt", new BsonInt32(7))));
        assertThat(
                bsonDocument,
                hasEntry(
                        "j",
                        new BsonDocument(
                                "$in", new BsonArray(newArrayList(new BsonInt32(8), new BsonInt32(9))))));
        assertThat(
                bsonDocument,
                hasEntry(
                        "k",
                        new BsonDocument(
                                "$in", new BsonArray(newArrayList(new BsonString("x"), new BsonString("y"))))));
        assertThat(
                bsonDocument,
                hasEntry(
                        "l",
                        new BsonDocument(
                                "$nin", new BsonArray(newArrayList(new BsonInt32(10), new BsonInt32(11))))));
        assertThat(bsonDocument, hasEntry("m", new BsonRegularExpression("foo", "")));
        assertThat(
                bsonDocument,
                hasEntry("n", new BsonDocument("$not", new BsonRegularExpression("^bar", ""))));
    ...
    public void testNumericValues() {
        BsonDocument bsonDocument =
                parse(format("a = %d and b = %d and c = %.1f", Integer.MAX_VALUE, Long.MAX_VALUE, 1.2));
    ...
    public void testDateLiteralValues() {
        ...
        BsonDocument bsonDocument =
                parse(format("a = '%s' and b = '%s'", dateLiteral, dateTimeLiteral));
    ...
    public void testUnsupportedDateLiteralValues() {
        RuntimeException actual =
                assertThrows(RuntimeException.class, () -> parse("a = '2017-10-27 10:05:45'"));
