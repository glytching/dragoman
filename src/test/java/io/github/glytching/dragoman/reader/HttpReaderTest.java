...
public class HttpReaderTest {
    ...
    @Test
    public void canRead() {
        Map<String, Object> one = TestFixture.anyMap();
        Map<String, Object> two = TestFixture.anyMap();
        ...
        List<DataEnvelope> dataEnvelopes = reader.read(dataset, select, where, orderBy, -1).toList().toBlocking()
                .single();
