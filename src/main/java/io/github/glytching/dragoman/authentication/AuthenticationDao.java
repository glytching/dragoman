...
/**
 * Defines the interaction with our authentication store. Implementations of this interface are
 * expected to be specific to a chosen data store technology e.g. MongoDB, a RDBMS etc.
 */
