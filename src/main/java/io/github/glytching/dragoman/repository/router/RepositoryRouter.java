...
/**
 * Routes datasets to repository. This application is configured with a set of {@link Repository}
 * instances, these are singletons and each {@link Dataset} can be associated with {@code 0..1}
 * {@link Repository} instance. This router is responsible for finding the correct {@link
 * Repository} instance for a given {@link Dataset}.
 */
public interface RepositoryRouter {
     ...
     *
     * @return a {@link Repository} implementation for the given {@code dataset} if one exists, an
     * exception otherwise
     */
