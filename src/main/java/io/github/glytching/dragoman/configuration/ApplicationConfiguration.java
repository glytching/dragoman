...
/**
 * Defines the well known configuration properties for this application. Implementations of this
 * interface are expected to be specific to whatever library/technology is chosen to integrate with
