...
import org.glytching.dragoman.ql.domain.Predicate;
 ...
 * {@link org.glytching.dragoman.ql.parser.WhereClauseParser}. Note: this is stateful so we one of these per {@code where}
 * expression but as long as the pattern of using a {@link org.glytching.dragoman.ql.parser.WhereClauseParser} is adhered
