 ...
 * {@link org.glitch.dragoman.ql.parser.SelectClauseParser}. Note: this is stateful so we one of these per {@code where}
 * expression but as long as the pattern of using a {@link org.glitch.dragoman.ql.parser.SelectClauseParser} is adhered
